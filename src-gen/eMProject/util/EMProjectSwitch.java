 ...
 * @generated
 */
public class EMProjectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EMProjectPackage.ENCLOS: {
			Enclos enclos = (Enclos) theEObject;
			T result = caseEnclos(enclos);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case EMProjectPackage.ANIMAL: {
		...
		case EMProjectPackage.CHIEN: {
			Chien chien = (Chien) theEObject;
			T result = caseChien(chien);
			if (result == null)
				result = caseAnimal(chien);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EMProjectPackage.SOIGNEUR: {
			Soigneur soigneur = (Soigneur) theEObject;
			T result = caseSoigneur(soigneur);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Enclos</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Enclos</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEnclos(Enclos object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Chien</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Chien</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChien(Chien object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Soigneur</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Soigneur</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSoigneur(Soigneur object) {
		return null;
	}
