...
public class ChatImpl extends MinimalEObjectImpl.Container implements Chat {
	...
	public Enclos getEnclos() {
		if (eContainerFeatureID() != EMProjectPackage.CHAT__ENCLOS)
			return null;
	...
	public NotificationChain basicSetEnclos(Enclos newEnclos, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newEnclos, EMProjectPackage.CHAT__ENCLOS, msgs);
		return msgs;
	}
	...
	public void setEnclos(Enclos newEnclos) {
		if (newEnclos != eInternalContainer()
				|| (eContainerFeatureID() != EMProjectPackage.CHAT__ENCLOS && newEnclos != null)) {
